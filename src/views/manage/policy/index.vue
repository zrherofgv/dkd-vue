<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="policyList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="序号" type="index" align="center" prop="policyId" width="50"/>
    ...
    <el-dialog :title="title" v-model="open" width="500px" append-to-body>
      <el-form ref="policyRef" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="策略方案" prop="discount">
          <el-input-number v-model="form.discount" :min="1" :max="100" :precision="0" placeholder="请输入策略方案" />
        </el-form-item>
      </el-form>
      <template #footer>
