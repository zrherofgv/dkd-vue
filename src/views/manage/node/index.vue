<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="合作商搜索" prop="partnerId" label-width="100">
    ...
    <el-table v-loading="loading" :data="nodeList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="所属区域" align="center" prop="region.name" />
    ...
    <!-- 查看详情对话框 -->
    <el-dialog title="查看详情" v-model="nodeOpen" width="600px" append-to-body>
