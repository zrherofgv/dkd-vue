<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryRef" :inline="true" v-show="showSearch" label-width="68px">
      <el-form-item label="合作商名称" prop="name" label-width="90">
        <el-input
    ...
    <el-table v-loading="loading" :data="partnerList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="操作" align="center" class-name="small-padding fixed-width" width="300">
        <template #default="scope">
          ...
          <el-button link type="primary"  @click="handleDetail(scope.row)" v-hasPermi="['manage:partner:query']">查看详情</el-button>
    ...
    <el-card class="box-card">
      ...
      <el-form label-position="right" label-width="80px">
        <el-form-item label="合作商名称" label-width="90">
          <span>{{ form.name }}</span>
        </el-form-item>
...
function resetPwd(row){
  const _id = row.id;
  proxy.$modal.confirm('你确定要重置该合作商的密码吗？' ).then(function() {
